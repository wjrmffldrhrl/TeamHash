...
//     }
    ...
    // 칸반보드
    @GetMapping("/project/{nickname}/{title}/kanban")
    public String kanban(@PathVariable("nickname") String nickname, @PathVariable("title") String title, Model model,  @CurrentUser Account account){
